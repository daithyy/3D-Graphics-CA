...
namespace GraphicsProject.Assets
{
    public class InputEngine : GameComponent
    {
        ...
        public override void Update(GameTime gametime)
        {
            ...
            if (DoRecenterMouse)
            {
                Mouse.SetPosition(GameUtilities.GraphicsDevice.Viewport.Width / 2, GameUtilities.GraphicsDevice.Viewport.Width / 2);
            }

            base.Update(gametime);
        }

        public static bool DoRecenterMouse { get; set; }
